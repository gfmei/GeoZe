...
class PointRenderer(nn.Module):
    ...
    The class combines rasterization, weight calculation, and compositing
    """
    ...
    def forward(self, points, features):
        ...
        """
        # Rasterize points -- bins set heuristically
        pcd = pytorch3d.structures.Pointclouds(points, features=features)
        idx, zbuf, dist_xy = rasterize_points(pcd, self.S, self.r, self.K)
        ...
        feats = pcd.features_packed().permute(1, 0)

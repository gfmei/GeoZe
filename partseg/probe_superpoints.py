...
VARIANTS = {
    ...
    'vccs':           dict(method='vccs'),
    'vccs@0.035':     dict(method='vccs', vccs_voxel=0.035),
    'vccs@0.08':      dict(method='vccs', vccs_voxel=0.08),
    'vccs+bnd':       dict(method='vccs', vccs_boundary=1.0),
    'vccs+ref':       dict(method='vccs', refine=3, w_v=1.0, self_tune=True),
    'vccs/grid':      dict(method='vccs', vccs_seed='grid'),
    'vccs_gpu':       dict(method='vccs_gpu'),
    'vccs_gpu+ref':   dict(method='vccs_gpu', refine=3, w_v=1.0, self_tune=True),
    'vccs_gpu+bnd':   dict(method='vccs_gpu', vccs_boundary=0.5),
    'vccs_gpu/curve': dict(method='vccs_gpu', vccs_seed='zcurve'),
